---
title: "Sample selection, censored samples and bayesian estimates - Diputados"
...
```{r}
asignacion_may_prop <- asignacion_mayoria |> full_join(asignacion_prop |> select(-tipo, -partido), 
                                                       by = c(".draw", "partido_nom")) |> 
